"""
QUAD8 FEM Solver - Numba JIT optimized version (v2 with NVTX profiling).
...
class Quad8FEMSolverNumba:
    ...
    - NVTX profiling annotations for Nsight Systems
    """
    ...
    def __init__(
        ...
        self.relative_residual: float = 0.0
    ...
    # =========================================================================
    # Main Workflow (with NVTX profiling annotations)
    # =========================================================================
    ...
    def run(
        ...
        """Run complete FEM simulation workflow with NVTX profiling."""
        ...
        with nvtx_range("load_mesh", color="purple"):
        ...
        with nvtx_range("assemble_system", color="blue"):
        ...
        with nvtx_range("apply_bc", color="yellow"):
        ...
        with nvtx_range("solve_system", color="red"):
        ...
        with nvtx_range("compute_derived", color="green"):

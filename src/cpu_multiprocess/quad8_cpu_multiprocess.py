...
class Quad8FEMSolverMultiprocess:
    ...
    Note: Uses true process-based parallelism, bypassing Python's GIL.
    """
    ...
    def assemble_system(self) -> None:
        ...
        # Process batches in parallel using Pool
        all_rows = []
        all_cols = []
        all_vals = []
    ...
    # =========================================================================
    # Post-Processing (multiprocessing.Pool)
    # =========================================================================
